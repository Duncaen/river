...
/// How many pixels the cursor has to be moved to reset the hide tiemout.
cursor_hide_jitter: u32 = 0,

/// How many pixels the cursor has to be moved to unhide it.
cursor_unhide_jitter: u32 = 0,
